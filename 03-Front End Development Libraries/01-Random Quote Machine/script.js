    ...
    return(
      <div id="quote-box" className="container-fluid">
        ...
        <div className="action-box">
          ...
          <a href="twitter.com/intent/tweet" target="_top" title="Tweet this quote!" id="tweet-quote"><i id="icon" className="fa fa-twitter"></i></a>
        </div>
      </div>
    );
  }
...
const colors = ["#343a40", "#fa5252", "#e64980", "#be4bdb", "#7950f2", "#4c6ef5", "#228be6", "#15aabf", "#12b886", "#40c057", "#82c91e", "#fab005", "#fd7e14", "#d9480f", "#e67700", "#5c940d", "#2b8a3e", "#087f5b", "#0b7285", "#1864ab", "#364fc7", "#5f3dc4", "#862e9c", "#a61e4d", "#c92a2a", "#212529"];
...
$(document).ready(function() {
  ...
  $("#text").html("&quot; " + currentQuote + " &quot;").css("color", currentColor);
  $("#author").html("&mdash; " + currentAuthor).css("color", currentColor);
